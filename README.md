...
## Dataset:
![alt text](Output/DS.png)

## Convolution Autoencoder Network Model

![alt text](Output/CNN.png)
...
print('Name: PRAVIN KUMAR A. Reg Number:212223230155')
autoencoder.summary()
...
![alt text](<Output/T Vz L.png>)

### Original vs Noisy Vs Reconstructed Image

![alt text](<Output/Original Vz Noisy.png>)
